...
const Loading= ({ onFinish }) => {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-black flex items-center justify-center text-white">
      ...
      {/* Corner Accents */}
      <div className="absolute top-8 left-8 w-10 h-10 border-t-2 border-l-2 border-purple-500"></div>
      <div className="absolute top-8 right-8 w-10 h-10 border-t-2 border-r-2 border-purple-500"></div>
      <div className="absolute bottom-8 left-8 w-10 h-10 border-b-2 border-l-2 border-purple-500"></div>
      <div className="absolute bottom-8 right-8 w-10 h-10 border-b-2 border-r-2 border-purple-500"></div>
